...
async function main() {
    ...
    const services = [
        { name: "Cuci Reguler", type: "REGULER", basePrice: 8000, pricePerKg: 8000 },
        { name: "Cuci Express", type: "EXPRESS", basePrice: 12000, pricePerKg: 12000, expressPct: 30 },
        { name: "Cuci Satuan", type: "SATUAN", basePrice: 15000 },
        { name: "Cuci Kiloan", type: "KILOAN", basePrice: 7000, pricePerKg: 7000 },
    ];
    ...
    const inventoryItems = [
        { name: "Deterjen Liquid", category: "DETERJEN", quantity: 50, unit: "liter", minStock: 10 },
        { name: "Pewangi", category: "PEWANGI", quantity: 30, unit: "liter", minStock: 5 },
        { name: "Plastik Kemasan", category: "PLASTIK", quantity: 200, unit: "pcs", minStock: 50 },
        { name: "Hanger", category: "HANGER", quantity: 100, unit: "pcs", minStock: 20 },
    ];
    for (const item of inventoryItems) {
        ...
        if (!exists)
            await prisma.inventory.create({ data: { ...item, branchId: branch.id } });
    }
