/** Default konten publik — disinkronkan dengan fe/src/data/public-content.ts */
export const DEFAULT_PUBLIC_CONTENT = {
  ...
  pricingRows: [
    { service: "Cuci Kering", price: "Rp 7.000/kg", estimate: "2–3 hari", minimum: "Min. 3 kg" },
    { service: "Cuci Setrika", price: "Rp 9.000/kg", estimate: "2–3 hari", minimum: "Min. 3 kg" },
    { service: "Express", price: "Rp 14.000/kg", estimate: "6–12 jam", minimum: "Min. 3 kg" },
  ],
  memberPackages: [
    {
      name: "Silver",
...
export type PublicContentData = typeof DEFAULT_PUBLIC_CONTENT;
